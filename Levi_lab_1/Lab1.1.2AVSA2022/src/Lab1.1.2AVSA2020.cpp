...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/levcsi/IPCV_Madrid/AVSA/Lab_1/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_name = "Lab1.1.2_CDNet2012"; // project exe name
