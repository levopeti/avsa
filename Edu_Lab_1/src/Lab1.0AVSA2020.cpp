...
// SECOND PART OF THE LAB 1
	//Paths for the dataset
	// In this example we assume that the dataset is available at
	// "/home/avsa/datasets/dataset2012lite/dataset/baseline/...
	string dataset_path = "/home/eduardo/Documents/Master_content/AVSA/Lab2/AVSA_LAB1_dataset2012lite/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
...
// FIRST PART OF THE LAB 1
//	string dataset_path = "/home/eduardo/Documents/AVSA/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/eduardo/Documents/eclipse_ws/Lab1.0AVSA2020/"; //SET THIS DIRECTORY according to your project
...
//	cout<<sizeof(dataset_cat)<<endl;
//	cout<<sizeof(dataset_cat[0])<<endl;
//	cout<<sizeof(dataset_cat[1])<<endl;
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			int threshold_ghosts2=25000000; // to set ... //Lab1.1.3
			bool rgb = false; //true;
			bool blind_mode = false; //Additional parameter to check the behaviour of the blind mode in Lab1.1.2 (instead of the selective_bkg_update)
			//If selective_bkg_update is set to true, is has preference over blind mode. Both to false would be the Lab1.1.1
			double alpha_sh=0.5;
			double beta_sh=0.9;
...
//			Lab1.1.3
			fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb, blind_mode); //construct object of the bgs class
